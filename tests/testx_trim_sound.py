from tts_audiobook_tool.app_types import Sound, SttVariant, SttConfig, TrimmableResult
...
trimmable_result = ValidateUtil.validate_item(sound, source_text, words, "en")
