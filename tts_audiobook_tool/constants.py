...
HINT_PROJECT_SUBDIRS = Hint(
    "project_subdirs",
    "FYI",
    f"""The subdirectory \"%1\" contains the individual audio files generated by the TTS model.
The subdirectory \"%2\" contains the final, concatenated audio file/s ready for playing."""
)
